...
Deep Chinese. Keep paper titles in their original language. Quote the exact text from the summary and source when flagging issues; preserve original-language quoted spans. Search queries, DOI lookups, and API parameters remain in English where required.
